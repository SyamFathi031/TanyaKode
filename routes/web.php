...
use App\Http\Controllers\ArticleController; // Import dari file Lama
...
use Barryvdh\DomPDF\Facade\Pdf; // Import dari file Lama
use Illuminate\Support\Str;     // Import dari file Lama

// --- PUBLIC ROUTES ---
Route::get('/', function () { return view('welcome'); });
// Tambahan dari file lama (Artikel)
...
Route::middleware(['auth'])->group(function() {
    ...
    Route::middleware([CekUserIsActive::class])->group(function () {
        ...
        Route::middleware(['role:student'])->prefix('user')->name('user.')->group(function () {
            ...
            // --- TAMBAHAN DARI FILE LAMA: LOGIC COMPLETE CONTENT ---
            Route::post('/content/{content}/complete', function ($contentId) {
                ...
                $progress = ($totalContent > 0) ? round(($completedContent / $totalContent) * 100, 2) : 0;
            ...
            // --- TAMBAHAN DARI FILE LAMA: LOGIC CERTIFICATE ---
